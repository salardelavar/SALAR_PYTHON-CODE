...
TRANSITION_MATRIX = np.array([
    [0.90, 0.10, 0.00, 0.00, 0.00],  # No Damage
    [0.00, 0.85, 0.15, 0.00, 0.00],  # Minor Damage
    [0.00, 0.00, 0.80, 0.20, 0.00],  # Moderate Damage
    [0.00, 0.00, 0.00, 0.70, 0.30],  # Severe Damage
    [0.00, 0.00, 0.00, 0.00, 1.00]   # Collapse
])
#---------------------------------------------------------------------------------
...
def estimate_transition_probabilities(num_simulations=1000):
