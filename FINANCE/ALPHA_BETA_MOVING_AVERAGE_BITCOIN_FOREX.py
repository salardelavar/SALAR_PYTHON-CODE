...
symbols = ["BTC-USD", "GC=F"]  # GC=F = Gold futures
...
# Define the y data as the BTC-USD price change
y_data = price_change["BTC-USD"]

# Define the x data as the other symbols price change
x_data = price_change.drop(columns=["BTC-USD"])
