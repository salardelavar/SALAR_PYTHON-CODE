...
t_exp = np.array([0.5, 2.0, 4.0, 7.0, 10.0, 15.0, 22.0])   # [s] time
x_exp = np.array([ 0.144518  , -0.06025869, -0.04571981, -0.04822565,  0.00911381,
                  -0.00283131, -0.00813343]) # [m] displacement
